...
public class ArcherAISpin : MonoBehaviour
{
    ...
    public bool turnCooldown = true;

    public int TurnCounter = 90;
    public float FirstTurn = 0;
    ...
    IEnumerator FirsTurn()
    {

        yield return new WaitForSeconds(FirstTurn);
        if (first == true)turnCooldown = false;
        first = false;
